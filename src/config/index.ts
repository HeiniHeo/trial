import { ChainId } from '@acentswap/ace-sdk'
...
export const ACENOS_BLOCK_TIME = 6 // FIXME block time

// FIXME acent explorer
export const BASE_EXPLORER_URLS = {
  [ChainId.MAINNET]: 'https://acent.crypto.org/explorer',
  [ChainId.TESTNET]: 'https://acent.crypto.org/explorer/testnet3',
}
...
export const BLOCKS_PER_YEAR = (60 / ACENOS_BLOCK_TIME) * 60 * 24 * 365 // 10512000
